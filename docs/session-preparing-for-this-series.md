...
- COBOL, Smalltalk, Java, Flex, Ruby on Rails, Node.js/MEAN, Python, learning Rust
- IMS/DB, Relational DBs, NoSQL DBs (MongoDB, Cosmos DB), Graphs
- Cloud Solution Architect (CSA) at Microsoft for 5 years
- Global Black Belt (GBB) at Microsoft for 4 years - Azure Cosmos DB and PostgreSQL
